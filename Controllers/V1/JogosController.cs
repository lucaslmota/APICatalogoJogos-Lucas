...
using APICatalogoJogos_Lucas.Service;
using APICatalogoJogos_Lucas.ViewModel;
using Microsoft.AspNetCore.Mvc;

namespace APICatalogoJogos_Lucas.Controllers.V1
{
    ...
    public class JogosController : ControllerBase
    {
        ...
        [HttpPut("{idJogo:guid}")]
        public async Task<ActionResult> Put([FromRoute] Guid idJogo, [FromBody] JogoInputModel jogoInputModel)
        {
            try
            {
                await _jogoService.Put(idJogo, jogoInputModel);
        ...
        public async Task<ActionResult> Patch([FromRoute] Guid idJogo, [FromRoute] double preco)
        {
            try
            {
